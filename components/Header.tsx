    ...
    <header className="bg-emerald-700 pt-3 pb-3 shadow-md relative z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="bg-emerald-800/60 rounded-lg px-3 py-1.5 border border-emerald-600/50 backdrop-blur-sm flex items-center gap-3 shadow-sm hover:bg-emerald-800/80 transition-colors cursor-pointer" title="આજનું હવામાન (363310)">
