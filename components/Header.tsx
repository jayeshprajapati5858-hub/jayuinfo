          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center gap-2 group">
               ...
               <div className="flex flex-col">
                 <h1 className="text-xl md:text-2xl font-black text-gray-900 leading-none tracking-tight">HYPER-LOCAL<span className="text-red-600">NEWS</span></h1>
                 <p className="text-[9px] font-bold text-gray-400 tracking-[0.2em] uppercase">News Portal</p>
               </div>
            </Link>
